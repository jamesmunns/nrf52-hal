...
// ===========================================================================
gpio!(P0, p0, P0_Pin [
    P0_0:  (p0_00,  0, Input<Floating>),
    P0_1:  (p0_01,  1, Input<Floating>),
    P0_2:  (p0_02,  2, Input<Floating>),
    P0_3:  (p0_03,  3, Input<Floating>),
    P0_4:  (p0_04,  4, Input<Floating>),
    P0_5:  (p0_05,  5, Input<Floating>),
    P0_6:  (p0_06,  6, Input<Floating>),
    P0_7:  (p0_07,  7, Input<Floating>),
    P0_8:  (p0_08,  8, Input<Floating>),
    P0_9:  (p0_09,  9, Input<Floating>),
